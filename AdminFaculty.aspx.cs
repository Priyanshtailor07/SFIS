...
namespace StudentFacultyManagementSystem
{
    public partial class AdminFaculty : Page
    {
        ...
        private void LoadFacultyData()
        {
            ...
            {
                string query = "SELECT FacultyID, FirstName, LastName, Email, PhoneNumber, Department FROM Faculty";
        ...
        protected void btnAddFaculty_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                string query = "INSERT INTO Faculty (FirstName, LastName, Email, Password, PhoneNumber, Department, JoiningDate) " +
                               "VALUES (@FirstName, @LastName, @Email, @Password, @PhoneNumber, @Department, @JoiningDate)";
                SqlCommand cmd = new SqlCommand(query, conn);
